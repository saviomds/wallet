...
- Name: tests\pages.spec.js >> e2e route Dashboard shows Quick Actions
...
Locator: getByText('Quick Actions')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Quick Actions')
    - waiting for" http://localhost:3000/e2e/dashboard" navigation to finish...
    - navigated to "http://localhost:3000/e2e/dashboard"

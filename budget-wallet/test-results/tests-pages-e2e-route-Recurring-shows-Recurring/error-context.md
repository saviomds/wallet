...
- Name: tests\pages.spec.js >> e2e route Recurring shows Recurring
...
Expected: visible
Error: strict mode violation: getByText('Recurring') resolved to 2 elements:
    1) <h1>Recurring</h1> aka getByRole('heading', { name: 'Recurring' })
    2) <div>…</div> aka getByText('↺No recurring rules yet.')
  ...
  - generic [ref=e2]:
    - generic [ref=e3]:
      - generic [ref=e4]:
        ...
        - heading "Recurring" [level=1] [ref=e6]
      - button "New Rule" [ref=e7] [cursor=pointer]:
        - img [ref=e8]
        - text: New Rule
    - generic [ref=e10]:
      - generic [ref=e11]: ↺
      - text: No recurring rules yet. Create one to automatically track regular transactions.
    - generic [ref=e12]:
      - strong [ref=e13]: "How it works:"
      - text: Rules are stored in your account settings. Automatic posting is coming — for now, use rules as a reminder and post transactions manually from the Add page.

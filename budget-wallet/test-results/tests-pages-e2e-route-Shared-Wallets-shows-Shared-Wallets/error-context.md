...
- Name: tests\pages.spec.js >> e2e route Shared Wallets shows Shared Wallets
...
Locator: getByText('Shared Wallets')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Shared Wallets')
    - waiting for" http://localhost:3000/e2e/shared-wallets" navigation to finish...
